...
from brag_doc_loader import BragDocLoader
...
query = f"Which of the brag document value prompts fits best to the following software engineering accomplishment? {brag}"
